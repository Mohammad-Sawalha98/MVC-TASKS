...
using Task_Nine.Models;

namespace Task_Nine.Controllers
{
    [HandleError(ExceptionType = typeof(DbException) , View = "DB_Error")]
    [HandleError(ExceptionType = typeof(ApplicationException), View = "Error")]
    public class CoursesController : Controller
    {
        private hErrorsEntities db = new hErrorsEntities();
