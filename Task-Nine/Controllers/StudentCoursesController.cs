...
namespace Task_Nine.Controllers
{
    public class StudentCoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "studentID,courseID,discription")] StudentCourse studentCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "studentID,courseID,discription")] StudentCourse studentCourse)
        {
            if (ModelState.IsValid)
            {
